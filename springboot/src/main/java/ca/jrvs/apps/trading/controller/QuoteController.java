...
public class QuoteController {
  ...
  @ApiOperation(value = "Add a new ticker to the dailyList (quote table)",
      notes = "Add a new ticker/symbol to the quote table, so the trader can trade this securely")
  ...
  @ApiOperation(value = "Show the dailyList", notes = "Show dailyList for this trading system. dailyList is the quote table")
